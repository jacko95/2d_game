...
public class Schermata extends JFrame {
	...
	int widthLabel = 480;
	int heightLabel = 480;
	Font font = new Font("Snap ITC", Font.BOLD, 60);
	
	/**
	 * Fa comparire una finestra quando si perde una partita
	 * @param scritta: stringa hai perso
	 */
	public Schermata(String scritta) {
